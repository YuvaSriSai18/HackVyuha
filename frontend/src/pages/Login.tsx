...
// Update the LocationState interface to handle both formats of "from" that can be passed
...
const Login = () => {
  ...
  // Handle both object format and string format for the "from" state
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Ensure we navigate after the state has been updated
      setTimeout(() => {
      ...
      >
        <div className="text-center">
          ...
          <p className="mt-2 text-neutral-600">
            Sign in to your ResearchChain account
          </p>
        </div>
